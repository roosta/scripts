...
License [MIT](./LICENSES/MIT-LICENSE.txt)
### [demo-notify.sh](./demo-notify.sh)

Dispatch notifications for demonstration purposes
...
License [MIT](./LICENSES/MIT-LICENSE.txt)
### [dosbox-staging-flatpak.sh](./dosbox-staging-flatpak.sh)

Launch dosbox-staging via flatpak, used in Lutris to launch using
dosbox-staging, as it needs a binary

Requirements:
- https://flatpak.org/
- https://flathub.org/en/apps/io.github.dosbox-staging

Usage:
```sh
./dosbox-staging-flatpak.sh
```
...
*This README was automatically generated by `generate-readme.sh` on 2026-08-09 17:32:24*
